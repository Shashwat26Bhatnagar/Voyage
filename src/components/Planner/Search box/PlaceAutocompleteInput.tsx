...
const PlaceAutocompleteInput = ({ onPlaceSelect }) => {
  ...
  return (
    <div className="relative">
      <input
        ref={inputRef}
        placeholder="Select a state or city in India"
        className="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-800/50 border border-green-500/30 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400"
      />
